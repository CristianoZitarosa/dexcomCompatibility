  ...
  render() {
    ...
    return (
      <div id="aboutMessage">
        ...
        <p>Dexcom is the owner of the brand, images of the Apps, style of the page, and the administrator of <strong>the original page</strong> you can reach <a href="https://www.dexcom.com/dexcom-international-compatibility" target="_blank" rel="noopener noreferrer"><strong id="linkDex">by this link</strong></a>.</p>
